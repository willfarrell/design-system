...
<LayoutCenter>
	<Article>
		...
		<P>TL;DR Private, Accisible, Sustanable, Secure</P>
		<Section>
			<H2>Features</H2>
			<Ul>
				<Li>Sematic HTML</Li>
		...
		<Section>
			...
			- Encrypt in transit / Encrypt in use / Encrypt at rest
			- EFF DNT
			<H3>Accessibility</H3>
			- WCAG 2.2 AAA / WCAG 3
			- rtl lang support (link)
			- vertical lang support (link)
			- date formatting
			- number formatting
			<H3>Sustainability</H3>
			- WSG Draft
			- Only ship what you need, when you need it
			<H3>Security</H3>
			- OSAWP Best practice
			- ASVS L3
			- CSP
