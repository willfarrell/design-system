...
<LayoutTableOfContents>
		...
		<NavScrollspy>
			<Section>
				...
				<Ul>
					...
					<Li><A href="#example-striped">Example (with class)</A></Li>
	...
	<Section>
		...
		<Snippet example="table" />
	</Section>
	<Section>
		<H2 id="example-striped">Example (<Code>class="stripe"</Code>)</H2>
		<Snippet example="table-stripe" />
	</Section>
	<Section>
