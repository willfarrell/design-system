...
This document outlines security procedures and general policies for the Design System Open Source projects as found on https://github.com/willfarrell/design-system.
...
Design System is implemented within the browser and server-side rendering. The configuration of the components is trusted. It's up to the implementing developer to apply input validation to ensure user inputs are properly structured and safe to use. User inputs to all packages are fuzzed.

## Reporting a Vulnerability

The Design System OSS team and community take all security vulnerabilities
