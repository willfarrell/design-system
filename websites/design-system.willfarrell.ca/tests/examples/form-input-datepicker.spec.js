...
const path = "/demo/form-input-datepicker";
...
test("WCAG 2.2 A 2.1.1 Keyboard — date inputs are keyboard accessible", async ({
	page,
}) => {
	await page.goto(path);
	await page.waitForLoadState("domcontentloaded");

	const inputs = page.locator('input[type="date"], input');
