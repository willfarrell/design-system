...
<svelte:head>
	...
	<meta name="description" content="The password input masks entered characters for security. Pair with a show/hide toggle for input verification." />
</svelte:head>
...
<LayoutTableOfContents>
	...
	<Section>
		...
		<P>The password input masks entered characters for security. Pair with a show/hide toggle button to allow users to verify their input.</P>
	</Section>
	<Section>
		<H2 id="example">Example</H2>
		<Snippet example="form-input-password" />
	</Section>
	<Section>
		<H2 id="accessibility">Accessibility</H2>
		<Ul>
			<Li>Use explicit <Code>&lt;label for="id"&gt;</Code> association.</Li>
			<Li>Use <Code>autocomplete="current-password"</Code> for login or <Code>autocomplete="new-password"</Code> for registration.</Li>
			<Li>Show/hide toggle should be a <Code>&lt;button&gt;</Code> (not a checkbox) with <Code>aria-pressed</Code> state to communicate the toggle state.</Li>
			<Li>Don't disable the input during async operations. Use error messages or status announcements instead.</Li>
		</Ul>
	</Section>
	<Section>
	...
	<Section>
		...
		<Ul>
			<Li><A href="/form/input-webauthn">WebAuthn</A> — for passwordless authentication</Li>
			<Li><A href="/form/input-text">Text input</A> — for non-sensitive text</Li>
		</Ul>
	</Section>
	<Section>
