...
<svelte:head>
	...
	<meta name="description" content="The one-time code input provides a text field for verification codes sent via SMS or email with automatic code detection." />
</svelte:head>
...
<LayoutTableOfContents>
	...
	<Section>
		...
		<P>The one-time code input provides a text field for entering verification codes sent via SMS or email. It uses <Code>autocomplete="one-time-code"</Code> to enable automatic code detection and autofill.</P>
	</Section>
	<Section>
		<H2 id="example">Example</H2>
		<Snippet example="form-input-one-time-code" />
	</Section>
	<Section>
		<H2 id="accessibility">Accessibility</H2>
		<Ul>
			<Li>Use explicit <Code>&lt;label for="id"&gt;</Code> association.</Li>
			<Li>Use <Code>autocomplete="one-time-code"</Code> to enable SMS autofill on supported devices.</Li>
			<Li>Use <Code>inputmode="numeric"</Code> to show a numeric keyboard on mobile.</Li>
			<Li>Inherit typography for WCAG 1.4.12 compliance.</Li>
		</Ul>
	</Section>
	<Section>
	...
	<Section>
		...
		<Ul>
			<Li><A href="/form/input-text">Text input</A> — for general text</Li>
			<Li><A href="/form/input-password">Password input</A> — often used together in authentication flows</Li>
		</Ul>
	</Section>
	<Section>
