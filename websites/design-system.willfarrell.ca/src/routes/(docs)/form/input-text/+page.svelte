...
<svelte:head>
	...
	<meta name="description" content="A text input accepts short, single-line text with a visible label, optional hint text, and error message support." />
</svelte:head>
...
<LayoutTableOfContents>
	...
	<Section>
		...
		<P>A text input accepts short, single-line text from the user. It is the default input type and should include a visible label, optional hint text, and error message support.</P>
	</Section>
	<Section>
		<H2 id="example">Example</H2>
		<Snippet example="form-input-text" />
	</Section>
	<Section>
		<H2 id="accessibility">Accessibility</H2>
		<Ul>
			<Li>Use explicit <Code>&lt;label for="id"&gt;</Code> association — not wrapping inputs in <Code>&lt;label&gt;</Code>. Explicit association provides better voice control support.</Li>
			<Li>Inherit typography on inputs: <Code>font: inherit; letter-spacing: inherit; word-spacing: inherit;</Code>. The <Code>font</Code> shorthand does not cascade <Code>letter-spacing</Code> and <Code>word-spacing</Code>, breaking WCAG 1.4.12 (Text Spacing).</Li>
			<Li>Do not disable inputs. Users cannot understand why interaction is blocked.</Li>
			<Li>Do not use <Code>readonly</Code> — screen reader support is inconsistent and there is no default visual styling.</Li>
		</Ul>
	</Section>
	<Section>
		<H2 id="references">References</H2>
		<Ul>
			<Li><A href="https://adrianroselli.com/2019/09/under-engineered-text-boxen.html">Under-Engineered Text Boxen</A> — Adrian Roselli</Li>
			<Li><A href="https://adrianroselli.com/2020/01/my-priority-of-methods-for-labeling-a-control.html">My Priority of Methods for Labeling a Control</A> — Adrian Roselli</Li>
			...
			<Li><A href="https://adrianroselli.com/2024/11/avoid-read-only-controls.html">Avoid Read-only Controls</A> — Adrian Roselli</Li>
		</Ul>
	</Section>
	<Section>
		<H2 id="related">Related</H2>
		<Ul>
			<Li><A href="/form/input-textarea">Textarea</A> — for multi-line text</Li>
			<Li><A href="/form/input-email">Email input</A> — for email addresses</Li>
