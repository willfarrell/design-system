...
<svelte:head>
	...
	<meta name="description" content="The number input accepts numeric values with browser-provided increment/decrement controls and mobile numeric keyboards." />
</svelte:head>
...
<LayoutTableOfContents>
	...
	<Section>
		...
		<P>The number input accepts numeric values. It includes browser-provided increment/decrement controls and restricts input to digits on mobile keyboards.</P>
	</Section>
	<Section>
		<H2 id="example">Example</H2>
		<Snippet example="form-input-number" />
	</Section>
	<Section>
		...
		<Ul>
			...
			<Li>The increment/decrement spinner buttons can be difficult for some users. Consider a plain text input with <Code>inputmode="numeric"</Code> and <Code>pattern="[0-9]*"</Code> for simpler numeric entry.</Li>
			<Li>Associate min, max, and step constraints via hint text using <Code>aria-describedby</Code>.</Li>
		</Ul>
	</Section>
	<Section>
	...
	<Section>
		...
		<Ul>
			<Li><A href="/form/input-text">Text input</A> — for general text entry</Li>
		</Ul>
	</Section>
	<Section>
