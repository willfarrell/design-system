...
<svelte:head>
	...
	<meta name="description" content="The URL input provides a text field for entering web addresses with URL validation and optimized mobile keyboard." />
</svelte:head>
...
<LayoutTableOfContents>
	...
	<Section>
		...
		<P>The URL input provides a text field for entering web addresses. It validates that the value is a properly formatted URL and shows a URL-optimized keyboard on mobile devices.</P>
	</Section>
	<Section>
		<H2 id="example">Example</H2>
		<Snippet example="form-input-url" />
	</Section>
	<Section>
		<H2 id="accessibility">Accessibility</H2>
		<Ul>
			<Li>Use explicit <Code>&lt;label for="id"&gt;</Code> association.</Li>
			<Li>Use <Code>autocomplete="url"</Code> to enable browser autofill.</Li>
			<Li>Inherit typography for WCAG 1.4.12 compliance.</Li>
			<Li>Provide hint text describing the expected format (e.g. "https://example.com") via <Code>aria-describedby</Code>.</Li>
		</Ul>
	</Section>
	<Section>
