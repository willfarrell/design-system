...
<svelte:head>
	...
	<meta name="description" content="The textarea provides a multi-line text input for longer content such as messages, descriptions, or comments." />
</svelte:head>
...
<LayoutTableOfContents>
	...
	<Section>
		...
		<P>The textarea provides a multi-line text input for longer content such as messages, descriptions, or comments.</P>
	</Section>
	<Section>
		<H2 id="example">Example</H2>
		<Snippet example="form-input-textarea" />
	</Section>
	<Section>
		<H2 id="accessibility">Accessibility</H2>
		<Ul>
			<Li>Use explicit <Code>&lt;label for="id"&gt;</Code> association.</Li>
			<Li>Inherit typography: <Code>font: inherit; letter-spacing: inherit; word-spacing: inherit;</Code> for WCAG 1.4.12 compliance.</Li>
			<Li>Do not use <Code>readonly</Code> — screen reader support is inconsistent.</Li>
			<Li>Communicate character limits via hint text using <Code>aria-describedby</Code>.</Li>
		</Ul>
	</Section>
	<Section>
	...
	<Section>
		...
		<Ul>
			<Li><A href="/form/input-text">Text input</A> — for single-line text</Li>
		</Ul>
	</Section>
	<Section>
