...
<svelte:head>
	...
	<meta name="description" content="The telephone input provides a text field optimized for phone numbers with a numeric dial pad on mobile devices." />
</svelte:head>
...
<LayoutTableOfContents>
	...
	<Section>
		...
		<P>The telephone input provides a text field optimized for phone numbers. Mobile devices display a numeric dial pad.</P>
	</Section>
	<Section>
		<H2 id="example">Example</H2>
		<Snippet example="form-input-tel" />
	</Section>
	<Section>
		<H2 id="accessibility">Accessibility</H2>
		<Ul>
			<Li>Use explicit <Code>&lt;label for="id"&gt;</Code> association.</Li>
			<Li>Use <Code>autocomplete="tel"</Code> to enable browser autofill.</Li>
			<Li>Inherit typography for WCAG 1.4.12 compliance.</Li>
			<Li>Provide hint text describing the expected format (e.g. "+1 555-123-4567") via <Code>aria-describedby</Code>.</Li>
		</Ul>
	</Section>
	<Section>
