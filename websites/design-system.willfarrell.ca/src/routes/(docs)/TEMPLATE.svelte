...
<LayoutTableOfContents>
  ...
  <Section>
    ...
    <P><!-- What it is and when to use it --></P>
    <P><!-- When NOT to use it (if applicable) --></P>
  </Section>
  <Section>
  ...
  <Section>
    ...
    <Ul>
      <Li><!-- Semantic HTML / ARIA roles --></Li>
  ...
  <Section>
    ...
    <Ul>
      <Li><A href=""><!-- Related component --></A> — <!-- when to use instead --></Li>
    </Ul>
  </Section>
  <Section>
