...
<svelte:head>
	...
	<meta name="description" content="Description lists associate terms with descriptions, suitable for glossaries, metadata, and key-value pairs." />
</svelte:head>
...
<LayoutTableOfContents>
	...
	<Section>
		...
		<P>Description lists associate terms with descriptions, suitable for glossaries, metadata, and key-value pairs. They offer better semantic structure than tables for this type of content.</P>
	</Section>
	<Section>
		<H2 id="example">Example</H2>
		<Snippet example="list-description" />
	</Section>
	<Section>
		<H2 id="accessibility">Accessibility</H2>
		<Ul>
			<Li>Screen reader support for <Code>&lt;dl&gt;</Code> is adequate across browsers, though Safari has inconsistencies with nested description lists.</Li>
			<Li>iOS VoiceOver (14+) supports description list navigation.</Li>
			<Li>CSS <Code>list-style</Code> on <Code>&lt;dl&gt;</Code> elements destroys semantics. Avoid applying list-related CSS to description lists.</Li>
			<Li>If screen readers must announce all nodes or users must navigate via list commands, consider alternative markup.</Li>
		</Ul>
	</Section>
	<Section>
		<H2 id="references">References</H2>
		<Ul>
			<Li><A href="https://adrianroselli.com/2022/12/brief-note-on-description-list-support.html">Brief Note on Description List Support</A> — Adrian Roselli</Li>
			<Li><A href="https://adrianroselli.com/2020/09/voiceover-on-ios-14-supports-description-lists.html">VoiceOver on iOS 14 Supports Description Lists</A> — Adrian Roselli</Li>
		</Ul>
	</Section>
	<Section>
		<H2 id="related">Related</H2>
		<Ul>
			<Li><A href="/text/list-ul">Unordered list</A> — for simple lists</Li>
			<Li><A href="/text/table">Table</A> — for complex tabular data</Li>
		</Ul>
	</Section>
	<Section>
