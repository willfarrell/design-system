...
<svelte:head>
	...
	<meta name="description" content="The blockquote element represents content quoted from another source. Use it for extended quotations with proper attribution." />
</svelte:head>
...
<LayoutTableOfContents>
	...
	<Section>
		...
		<P>The blockquote element represents content quoted from another source. Use it for extended quotations with proper attribution via <Code>&lt;footer&gt;</Code> and <Code>&lt;cite&gt;</Code>.</P>
	</Section>
	<Section>
		<H2 id="example">Example</H2>
		<Snippet example="blockquote" />
	</Section>
	<Section>
		<H2 id="accessibility">Accessibility</H2>
		<Ul>
			<Li>The <Code>&lt;blockquote&gt;</Code> element has an implicit ARIA role of <Code>blockquote</Code>. JAWS is the only screen reader with blockquote-specific navigation.</Li>
			<Li>Screen reader behavior varies across implementations — no single blockquote pattern produces consistent announcements across all screen readers.</Li>
			<Li>The <Code>cite</Code> attribute on <Code>&lt;blockquote&gt;</Code> creates verbosity in some screen readers. Use a visible <Code>&lt;cite&gt;</Code> element within <Code>&lt;footer&gt;</Code> instead.</Li>
		</Ul>
	</Section>
	<Section>
		<H2 id="references">References</H2>
		<Ul>
			<Li><A href="https://adrianroselli.com/2023/07/blockquotes-in-screen-readers.html">Blockquotes in Screen Readers</A> — Adrian Roselli</Li>
		</Ul>
	</Section>
	<Section>
		<H2 id="related">Related</H2>
		<Ul>
			<Li><A href="/text/paragraph">Paragraphs</A> — for non-quoted body text</Li>
			<Li><A href="/text/callout">Callout</A> — for highlighted non-quoted content</Li>
		</Ul>
	</Section>
	<Section>
