...
<svelte:head>
	...
	<meta name="description" content="The disclosure widget uses native details and summary elements to show and hide content for simple show/hide interactions." />
</svelte:head>
...
<LayoutTableOfContents>
		...
		<NavScrollspy>
			{#snippet children()}
				<Ol>
					...
					<Li><A href="#example-chevron">Example (with class)</A></Li>
	...
	<Section>
		...
		<P>The disclosure widget uses native <Code>&lt;details&gt;</Code> and <Code>&lt;summary&gt;</Code> elements to show and hide content. Use for simple show/hide interactions such as FAQs, additional context, or collapsible sections.</P>
		<P>Do not use <Code>&lt;details&gt;</Code>/<Code>&lt;summary&gt;</Code> as a replacement for accordions, tabs, menus, or dialogs — they are disclosure widgets only.</P>
	</Section>
	<Section>
		<H2 id="example">Example</H2>
		<Snippet example="details" />
	</Section>
	<Section>
		<H2 id="example-chevron">Example (<Code>class="chevron"</Code>)</H2>
		<Snippet example="details-chevron" />
	</Section>
	<Section>
		<H2 id="accessibility">Accessibility</H2>
		<Ul>
			<Li><Code>&lt;summary&gt;</Code> has an implicit button role with <Code>aria-expanded</Code> state managed by the browser.</Li>
			<Li><Code>&lt;summary&gt;</Code> neutralizes nested element semantics — a heading inside <Code>&lt;summary&gt;</Code> will not be announced as a heading.</Li>
			<Li>No JavaScript is required for basic disclosure, but interactive patterns beyond simple show/hide need JavaScript for proper state management.</Li>
			<Li>CSS-only interactive widgets cannot manage ARIA state and are inaccessible.</Li>
		</Ul>
	</Section>
	<Section>
		<H2 id="references">References</H2>
		<Ul>
			<Li><A href="https://adrianroselli.com/2020/05/disclosure-widgets.html">Disclosure Widgets</A> — Adrian Roselli</Li>
			<Li><A href="https://adrianroselli.com/2019/04/details-summary-are-not-insert-control-here.html">Details / Summary Are Not [insert control here]</A> — Adrian Roselli</Li>
			<Li><A href="https://adrianroselli.com/2023/03/css-only-widgets-are-inaccessible.html">CSS-only Widgets Are Inaccessible</A> — Adrian Roselli</Li>
		</Ul>
	</Section>
	<Section>
		<H2 id="related">Related</H2>
		<Ul>
			<Li><A href="/text/accordion">Accordion</A> — for grouped disclosure sections</Li>
			<Li><A href="/component/dialog">Dialog</A> — for modal content</Li>
			<Li><A href="/component/popover">Popover</A> — for non-modal overlays</Li>
		</Ul>
	</Section>
	<Section>
		<H2 id="variables">Variables</H2>
		<P>None for disclosure</P>
	</Section>
</LayoutTableOfContents>
