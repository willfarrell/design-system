...
<svelte:head>
	...
	<meta name="description" content="Formats a raw byte value into a human-readable file size string using locale-aware formatting" />
</svelte:head>
...
<LayoutTableOfContents>
	...
	<Section>
		...
		<P>The DataBytes component formats a raw byte value into a human-readable file size string (e.g. KB, MB, GB) using <Code>Intl.NumberFormat</Code> for locale-aware formatting.</P>
		<P>Use DataBytes when displaying file sizes, storage quotas, or transfer amounts. For plain numbers without unit conversion, use <A href="/component/data-number">DataNumber</A>.</P>
	</Section>
	<Section>
		<H2 id="example">Example</H2>
		<Snippet example="data-bytes" />
	</Section>
	<Section>
		<H2 id="accessibility">Accessibility</H2>
		<Ul>
			<Li>Renders as a <Code>&lt;data&gt;</Code> element with the raw byte value preserved in the <Code>value</Code> attribute</Li>
			<Li>Screen readers announce the formatted text content</Li>
			<Li>Locale-aware formatting respects the user's language preferences</Li>
		</Ul>
	</Section>
	<Section>
		<H2 id="related">Related</H2>
		<Ul>
			<Li><A href="/component/data-number">DataNumber</A> — for plain number formatting</Li>
			<Li><A href="/component/data-time">DataTime</A> — for date formatting</Li>
		</Ul>
	</Section>
	<Section>
