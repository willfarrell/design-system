...
import InputName from "@design-system/components/InputName.svelte";
...
import InputOrganization from "@design-system/components/InputOrganization.svelte";
...
import InputTel from "@design-system/components/InputTel.svelte";
...
{/snippet}
<Form method="POST">
	<InputOrganization id="organization" {labelSnippet} label="Organization" hint="The company or organization you represent" />
